...
<body>
    <h1 class="text-center mb-4">edit Data Lokasi</h1>
    <div class="container">
                    ...
                    <div class="card-body">
                        <form action="/updatelokasi/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="negara" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->negara}}">
                                @error('negara')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kabupaten" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->kabupaten}}">
                                @error('kabupaten')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="desa" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->desa}}">
                                @error('desa')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="dusun" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->dusun}}">
                                @error('dusun')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" name="kodepos" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->kodepos}}">
                                @error('kodepos')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
